...
var markBills = {
    bills: [77, 475, 110, 45],  // an array within the object, containing the bills
    //[77, 375, 110, 45]
    calcTip: function() {
        for (var i = 0; i < this.bills.length; i++) {
...
function averageTipCalculator(billName) {
    ...
    // console.log(this.sum);
    this.averageTip = this.sum / this.tips.length;
